...
def find_similar_anime(anime_name, num_similar=5):
    anime_row = anime_df[anime_df['name'].str.strip().str.lower() == anime_name]
...
if anime_exists(query_anime_name):
    similar_anime = find_similar_anime(query_anime_name)
